...
/**
 * This function configures SysTick reload value and enables SysTick interrupt
 * so that SysTick interrupt is triggered every 1 ms.
 */
void SysTick_config() {
	...
	SysTick->LOAD = 47999 << SysTick_LOAD_RELOAD_Pos;
